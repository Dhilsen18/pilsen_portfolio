  ...
  const projects = [
    {
      ...
      previewImage: '/images/proyectos/project2-image1.jpg',
      ...
      demoLink: '#',
      images: [
        '/images/proyectos/project2-image1.jpg',
        '/images/proyectos/project2-image2.jpg',
        '/images/proyectos/project2-image3.jpg',
        '/images/proyectos/project2-image4.jpg',
        '/images/proyectos/project2-image5.jpg',
      ],
    },
    {
      id: 2,
      // La primera imagen se usará como la vista previa en la tarjeta
      previewImage: '/images/proyectos/project3-image1.jpg',
      ...
      images: [
        '/images/proyectos/project3-image1.jpg',
        '/images/proyectos/project3-image2.jpg',
        '/images/proyectos/project3-image3.jpg',
        '/images/proyectos/project3-image4.jpg',
        '/images/proyectos/project3-image5.jpg',
      ],
    },
  ];
